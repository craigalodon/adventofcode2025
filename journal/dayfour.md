...
making the math operations pretty simple. Re-iterating through all the rolls each
time seems inefficient to me. I also don't like the rat's nest of if statements
and manual calculations in the `getAdjacent` function.
